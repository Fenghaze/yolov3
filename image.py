...
def distort_image(im, hue, sat, val):
    ...
    :param im: RGB image.
    :param hue: shade of image color.
    :param sat: amound of image color.
...
def fill_truth_detection(labpath, w, h, flip, dx, dy, sx, sy):
    # in fact, in pascal voc 2007 dataset, there are at most 38 labels in one image.
    max_boxes = 50
